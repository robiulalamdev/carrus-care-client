  ...
  return (
    <>
      <div className="bg-[#55100C] bg-opacity-75 h-10 w-full">
        <div className="max-w-[1480px] h-full mx-auto flex justify-end items-center gap-8 px-2">
      ...
      <div className="hidden md:block py-2 px-2 shadow">
        <div className="flex justify-between items-center max-w-[1480px] mx-auto">
